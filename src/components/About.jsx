        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
          ...
          >
            <p className="text-neutral-200 leading-relaxed text-[15px]">
              ...
              production-grade AI/ML systems, backend architecture, and scalable full-stack development.
            </p>
            <p className="text-neutral-200 leading-relaxed text-[15px]">
              At UIC Technology Solutions, Dev shipped full-stack internal automation and web
              platforms using React.js, FastAPI, and SQL to streamline student and staff support
              workflows — improving resolution time by 35%, increasing first-contact resolution
              by 25%, and saving 10+ hours per week across the support team.
            </p>
            <p className="text-neutral-200 leading-relaxed text-[15px]">
            ...
            <blockquote className="mt-8 border-l-2 border-blue-500 pl-5">
              ...
              <footer className="text-xs text-neutral-400 mt-2 not-italic tracking-wide">
          ...
          >
            ...
            <ul className="space-y-3.5">
              {focusAreas.map((area) => (
                <li key={area} className="flex items-center gap-3 text-sm text-neutral-200">
            ...
            <div className="mt-10 pt-8 border-t border-neutral-900 space-y-3">
              <div>
                <p className="text-[10px] text-neutral-500 uppercase tracking-widest mb-1">University</p>
                <p className="text-sm text-neutral-200">University of Illinois Chicago</p>
              </div>
              <div>
                <p className="text-[10px] text-neutral-500 uppercase tracking-widest mb-1">Graduation</p>
                <p className="text-sm text-neutral-200">December 2025</p>
              </div>
              <div>
                <p className="text-[10px] text-neutral-500 uppercase tracking-widest mb-1">Location</p>
                <p className="text-sm text-neutral-200">Chicago, Illinois</p>
              </div>
            </div>
          </div>
