...
const bullets = [
  'Designed and deployed internal automation systems using Python, JavaScript, and FastAPI to streamline workflows serving 10,000+ active users.',
  'Built modular automation pipelines for device provisioning, data validation, and recurring operations, eliminating 10+ hours of manual effort weekly.',
  'Standardized service processes to improve reliability and increased first-contact resolution rate by 25%.',
  'Developed internal tooling using REST APIs and lightweight web interfaces to convert recurring technical issues into scalable software solutions.',
  'Operated across Windows, macOS, and Linux environments, strengthening debugging and systems-level thinking across heterogeneous infrastructure.',
];
          ...
          <div className="border border-neutral-800 hover:border-neutral-700 transition-colors duration-300 p-8 md:p-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
              ...
              <div className="flex flex-col items-start sm:items-end gap-1.5">
                <span className="text-[11px] font-medium text-neutral-500 tracking-widest uppercase border border-neutral-800 bg-neutral-900/50 px-3 py-1.5">
                  2023 — Present
                </span>
            ...
            <ul className="space-y-4">
              {bullets.map((bullet, i) => (
                <li key={i} className="flex gap-4 text-sm text-neutral-400 leading-relaxed">
            ...
            <div className="mt-8 pt-6 border-t border-neutral-900 flex flex-wrap gap-2">
              {techUsed.map((tech) => (
                <span
                  key={tech}
                  className="text-[11px] text-neutral-500 border border-neutral-800 px-2.5 py-1 bg-neutral-900/30"
                >
                  {tech}
                </span>
              ))}
