  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-28 pb-20 w-full">
        ...
        >
          <div className="inline-flex items-center gap-2.5 text-xs text-neutral-500 border border-neutral-800 rounded-full px-4 py-2 mb-8">
        ...
        {/* Subheadline */}
        <p
          className={`text-lg md:text-xl text-neutral-400 max-w-2xl leading-relaxed mb-4 transition-all duration-700 delay-200 ${mounted ? visible : hidden}`}
        >
        ...
        {/* Bio */}
        <p
          className={`text-sm md:text-base text-neutral-500 max-w-2xl leading-relaxed mb-10 transition-all duration-700 delay-300 ${mounted ? visible : hidden}`}
        >
